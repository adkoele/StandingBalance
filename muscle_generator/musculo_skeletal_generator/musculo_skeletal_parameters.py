...
class MuscleJointParameters(SystemParameters):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['muscle_type'] = kwargs.get('muscle_type', 'mono')
        self.parameters['r_0'] = kwargs.get('r_0', '1.')
        self.parameters['joint_attach'] = kwargs.get('joint_attach', 'joint')
        self.parameters['theta_max'] = kwargs.get('theta_max', 0.0)
        self.parameters['theta_ref'] = kwargs.get('theta_ref', 0.0)
        self.parameters['direction'] = kwargs.get('direction', 'clockwise')
...
class JointParameters(SystemParameters):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['passive_stiffness'] = kwargs.get('passive_stiffness', 0.0)
    ...
    def passive_stiffness(self, value):
        """Keyword Arguments:
           value --  Amount of passive stiffness """
