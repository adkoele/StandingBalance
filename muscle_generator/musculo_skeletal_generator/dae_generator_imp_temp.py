...
class DaeGenerator(object):
    ...
    def __init__(self):
        ...
        self.imp = Parameters()  #: ODE IMPLICIT
    ...
    def add_imp(self, name, ode):
        """Add a new ode imp.
         ----------
        name : <str>
            Name of the new imp
        ode : <cas.SX.sym>
            Symbolic IMP equation
        """
        self.imp.add(name, ode)
        return self.imp.param_list[-1]
    ...
    def generate_dae(self):
        ...
        dae = {'x': cas.vertcat(*self.x.get_all_sym()),
               ...
               'dae': cas.vertcat(*self.imp.get_all_sym()),
